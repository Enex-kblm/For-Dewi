...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-pink-200 to-rose-300 overflow-hidden">
      {/* Lilin */}
      <div className="cake">
      ...
      <svg
        ...
        xmlSpace="preserve"
        className="block relative -mt-40 mx-auto"
      >
        <path
          fill="#a88679"
        ...
        >
          <animate
            ...
            values="
              ...
              c-6.592,0-12.871,7.371-19.166,3.008c-10.043-6.961-7.776-10.169,2.991-17.745c12.610-8.873,27.713,1.994,25.919-7.531
      ...
      {/* Teks Ucapan */}
      <div className="text text-center mt-6 font-lato font-light italic text-[#8b6a60]">
        <h1 className="text-2xl font-bold">happy birthday!</h1>
        <p className="name text-xl font-semibold mt-2">Lovie</p>
      </div>
